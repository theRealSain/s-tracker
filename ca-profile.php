      ...
      <div class="layout-container">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item">
              <a href="ca-profile.php"class="menu-link" id="active-side-menu">
            ...
            <div class="profile-wrapper">
              <div class="profile-card">
                    ...
                    <div class="modal-dialog" role="document">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          ...
                          <div class="row">
                            <div class="col mb-3">
                              <label for="clnameBasic" class="form-label">Class Name</label>
                              <input type="text" id="clnameBasic" class="form-control" placeholder="Edit Class Name" name="class_name" required value="<?php echo "{$info['class_name']}" ?>"/>
                            </div>
                          </div>
                          ...
                          <div class="row">
                            <div class="col mb-3">
                              ...
                              <input type="text" id="clidBasic" class="form-control" placeholder="Edit Class ID" name="class_id" required value="<?php echo "{$info['class_id']}" ?>"/>
                            </div>
                          </div>
                ...
                if(isset($_POST['update']))
                {
                   ...
                   $query = "UPDATE class_admin SET fname='$fname', phone='$phone', id='$cadmin_id', password='$password', class_name='$class_name', class_id='$class_id', college_id='$college_id' WHERE id='$id' ";
                ...
                <form method="POST" action="ca-profile-picture.php"name="profile-pic" enctype="multipart/form-data">
              ...
              ?>
                ...
                <script>
                      function deleteProfilePicture()
                      {
                        if (confirm("Are you sure you want to remove the profile picture?"))
                        {
                          ...
                          xhr.open("GET", "ca-dp-delete.php", true);
                ...
                <table class="table" id="profile-data">
                    ...
                    <tr><th></th></tr>
                    <tr><th>Role</th></tr>
                    <tr><td>Class Teacher</td></tr>
                    <tr><th></th></tr>
                    <tr><th>ID</th></tr>
                    <tr><td><?php echo "{$info['id']}" ?></td</tr>
                    <tr><th></th></tr>
                    <tr><th>Class Name</th></tr>
                    <tr><td><?php echo "{$info['class_name']}" ?></td></tr>
                    <tr><th></th></tr>
                    <tr><th>Class ID</th></tr>
                    <tr><td><?php echo "{$info['class_id']}" ?></td></tr>
                    <tr><th></th></tr>
                    <tr><th>College</th></tr>
