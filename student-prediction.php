...
$sc_sql = "SELECT * FROM student_course WHERE student_id = '$id' AND course_id = '$course_id' ";
      ...
      <div class="layout-container">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item">
              <a href="student-courses.php" class="menu-link" id="active-side-menu">
              <svg class="side-icons"  xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" width=18 fill=#755dff>
          ...
          <form action="" method="POST">
            ...
            <section class="details-area">
              ...
              <table border=1 style="margin-bottom: 20px;">
                <tr>
                  <th>Name</th><td><?php echo "{$info['fname']}"; ?></td>
                </tr>
                <tr>
                  <th>Student ID</th><td><?php echo "{$info['id']}"; ?></td>
                </tr>
                <tr>
              ...
              <span class="predict">Your Predicted score for <?php echo "{$c_info['cname']}: $prediction%"; ?></span>
              <?php
              if ($prediction <= 35) 
               {
                 echo "<br>";
                 echo "<span style='color: red;text-align: center; margin: auto;display: block; '>Score below passing threshold. Please work on improving your performance!</span>";
               }
               if ($prediction >= 90) 
               {
                 echo "<br>";
                 echo "<span style='color: green;text-align: center; margin: auto;display: block; '>Congratulations! Your predicted score is exceptional!</span>";
               }
               ?>
