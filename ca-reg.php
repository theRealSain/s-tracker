        ...
        <div class="authentication-inner">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <form id="formAuthentication" class="mb-3" action="ca-registration.php" method="POST">
              ...
              <div class="mb-3">
                ...
                <div class="mb-3">
                  ...
                  <input type="text" class="form-control" id="email" name="class_id"
                    placeholder="Enter Class ID" autofocus required>
                </div>
                ...
                <span class="reg">Already have an account? <a href="ca-login.php">Sign In</a></span><br>
