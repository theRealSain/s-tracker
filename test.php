          ...
          <section class="course-student">
            <form action="#" method="POST">
              <div class="studentview" style="margin: 40px 0px 80px 120px; width: 95%">
                ...
                <select class="form-control" id="course-select" name="attendance_form" onchange="this.form.submit()">
                    ...
                    ?> 
                      ...
                      <?php
                          ...
                          {
                            $selected_class_id=$_POST['attendance_form'];
                            $a_sql = "SELECT * FROM student_table WHERE class_id = '$selected_class_id';";
                            


                            $cn_sql = "SELECT * FROM class_admin WHERE class_id = '$selected_class_id' ";
                ...
                <span class="at-crs" id="cname">Class: <?php echo $cn_info['class_name']; ?></span>
