      ...
      <div class="layout-container">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item">
              <a href="ca-students.php" class="menu-link">
            ...
            <li class="menu-item">
              <a href="ca-courses.php" class="menu-link" id="active-side-menu">
                <svg class="performance"  xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" width=18 fill=#755dff>
        ...
        <div class="layout-page">
          ...
          <form action="" method="POST" id="class_form">
            <div class="contain">
              <h1 class="contain-head"><img src="Images/favicon.ico">manage courses</h1>
                ...
                <div class="col-md-6 col-lg-4" id="class-cover">
                  <div class="card mb-3" id="class-blocks">
                    <div class="card-body">
                      ...
                      <p class="card-text">Create a course by inputting various fields given in a popup.</p>
                        ...
                        <div class="modal-dialog" role="document">
                          <div class="modal-content">
                            <div class="modal-header">
                              <h5 class="modal-title" id="exampleModalLabel1">Create course</h5>
                              <button
                                type="button"
                                class="btn-close"
                            ...
                            <div class="modal-body">
                              <div class="row">
                                <div class="col mb-3">
                                  ...
                                  <input type="text" id="nameBasic" class="form-control" placeholder="Enter Course Name" name="cname" required/>
                                </div>
                              </div>

                              <div class="row">
                                <div class="col mb-3">
                                  <label for="idBasic" class="form-label">Course ID</label>
                                  <input type="text" id="idBasic" class="form-control" placeholder="Enter Course ID" name="c_id" required/>                                  
                                </div>
                              </div>

                              <div class="row">
                                <div class="col mb-3">
                                  <label for="tidBasic" class="form-label">Teacher ID</label>                                  
                                  <select class="form-control" name="tr_id">
                                   <option selected hidden>Choose a teacher</option>
                                    <?php              
                                     $c2_sql = "SELECT * FROM teacher_table WHERE college_id = '$college_id' ";
                                     ...
                                     {                      
                                       ...
                                       echo "<option value='" . $teacher_id. "'>" . $row['fname'] . "</option>";
                                     }
                                    ?> 
                                  </select>
                                </div>
                              ...
                              <div class="row">
                                <div class="col mb-3">
                                  ...
                                  <input type="text" id="cidBasic" class="form-control" placeholder="Enter Class ID" name="class_id" value="<?php echo "$class_id" ?>" required/>
                                </div>
                              </div>
                            ...
                            <div class="modal-footer">
                              ...
                              <button type="submit" class="btn btn-primary" name="add-course">Create Course</button>
                            </div>
                          </div>
                        </div>
                      </div>
                      ...
                      if(isset($_POST['add-course']))
                      {
                        ...
                        $college_id = $_POST['college_id'];
                         ...
                         $sql = "INSERT INTO courses(cname, id, teacher_id, class_id, college_id) VALUES('$cname', '$c_id', '$teacher_id', '$class_id', '$college_id')";                         
                         $result = mysqli_query($data, $sql);

                         if($result)
                         {
                            $_SESSION['course_add'] = 'Course Added Succesfully!';
                            header("location:ca-courses.php");
                         }
                         else
                         {
                             $_SESSION['no_course_add'] = 'Failed to add course. Try again!';
                             header("location:ca-courses.php");
                         }
                      }
                      ?>
              ...
              <?php #echo "<a href='admin-course-students.php?id=$course_id' style='color: inherit'>"; ?>

              <?php
                $c_sql = "SELECT * FROM courses WHERE class_id = '$class_id' ";
                $c_result = mysqli_query($data, $c_sql);
                $c_info = mysqli_fetch_all($c_result);
                foreach($c_info as $course)
                {
                  ...
                  $tn_sql = "SELECT * FROM teacher_table WHERE id = '$ter_id' ";
                  ...
                  foreach($tn_info as $teacher)
                  {
                    ...
                    $cls_sql = "SELECT * FROM class_admin WHERE class_id = '$cls_id' ";
              ...
              <?php
                echo "<a href='ca-course-add.php?id=$course_id' style='color: inherit;'>";
              ...
              <div class="course">
                <span class="course-left">
                  <svg class="grad" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512" width=25><!--! Font Awesome Free 6.3.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free (Icons: CC BY 4.0, Fonts: SIL OFL 1.1, Code: MIT License) Copyright 2023 Fonticons, Inc. --><path d="M320 32c-8.1 0-16.1 1.4-23.7 4.1L15.8 137.4C6.3 140.9 0 149.9 0 160s6.3 19.1 15.8 22.6l57.9 20.9C57.3 229.3 48 259.8 48 291.9v28.1c0 28.4-10.8 57.7-22.3 80.8c-6.5 13-13.9 25.8-22.5 37.6C0 442.7-.9 448.3 .9 453.4s6 8.9 11.2 10.2l64 16c4.2 1.1 8.7 .3 12.4-2s6.3-6.1 7.1-10.4c8.6-42.8 4.3-81.2-2.1-108.7C90.3 344.3 86 329.8 80 316.5V291.9c0-30.2 10.2-58.7 27.9-81.5c12.9-15.5 29.6-28 49.2-35.7l157-61.7c8.2-3.2 17.5 .8 20.7 9s-.8 17.5-9 20.7l-157 61.7c-12.4 4.9-23.3 12.4-32.2 21.6l159.6 57.6c7.6 2.7 15.6 4.1 23.7 4.1s16.1-1.4 23.7-4.1L624.2 182.6c9.5-3.4 15.8-12.5 15.8-22.6s-6.3-19.1-15.8-22.6L343.7 36.1C336.1 33.4 328.1 32 320 32zM128 408c0 35.3 86 72 192 72s192-36.7 192-72L496.7 262.6 354.5 314c-11.1 4-22.8 6-34.5 6s-23.5-2-34.5-6L143.3 262.6 128 408z"/>
                  </svg>
                </span>
                <h1 class="course-head"><?php echo $course_name; ?></h1>
                      
                <?php
                echo "<a onClick=\" javascript:return confirm('Are you sure to delete this course?')\" href='ca-course-delete.php?id=$course_id' style='color: inherit;'><img src='Images/z_delete.png' class='crs-del'></a>";
                ?>
            ...
            <?php
              ...
              unset($_SESSION['course_del']);

                  if($_SESSION['crs-std-del'])
                  {
                    echo "<div class='alert alert-primary alert-dismissible' role='alert' id='alert_toast' style='width: fit-content;
                              font-size: 1rem; margin: auto; margin-top: 10px;'>"
                    .$_SESSION['crs-std-del'].
                    "<button type='button' class='btn-close' data-bs-dismiss='alert' aria-label='Close'></button>
                  </div>";
                  }
                  unset($_SESSION['crs-std-del']);
              ?>
