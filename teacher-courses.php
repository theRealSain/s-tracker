              ...
              <ul class="navbar-nav flex-row align-items-center ms-auto">
                ...
                <section class="class-teachers">
                  <form action="" method="POST" id="course_form">
                    <div class="contain">
                        <h1 class="contain-head"><img src="Images/favicon.ico">Your Courses</h1>
                        ...
                        Choose a course from the list below to view the students under each course.</p>
                          ...
                          {                    
                              ...
                              foreach($tn_info as $teacher)
                              {
                                  ...
                                  foreach($cls_info as $class)
                                  {
                                      ...
                                      echo "
                                      <a href='teacher-course-students.php?id={$course_id}' style='color: inherit;'>
                                      ";
                        ?>
