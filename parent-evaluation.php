      ...
      <div class="layout-container">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item">
              <a href="parent-eval-intro.php" class="menu-link" id="active-side-menu">
              <svg class="side-icons" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" width=20 fill=#755dff>
        ...
        <section class="course-student">
            <a href="parent-evaluation.php">Add rating now</a>
        </section>
        ...
        <div class="layout-page">
            ...
            <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
              ...
              <ul class="navbar-nav flex-row align-items-center ms-auto">
                ...
                <!--/ User -->
                        ...
                        if($_SESSION['message'])
                          {
                            echo "<div class='alert alert-success alert-dismissible' role='alert' id='alert_toast' style='margin-top: 20px; margin-bottom: 20px;'>"
                            .$_SESSION['message'].
                        ...
                        if($_SESSION['xmessage'])
                          {
                            echo "<div class='alert alert-danger alert-dismissible' role='alert' id='alert_toast' style='margin-top: 20px; margin-bottom: 20px;'>"
                            .$_SESSION['xmessage'].
                            "<button type='button' class='btn-close' data-bs-dismiss='alert' aria-label='Close'></button>
                          </div>";
                          }
          ...
          <section class="course-student">
            ...
            <div class="studentview" style="margin: 100px 0px 80px 120px; width: 80%">

              <h2 class="c-h"><img src="favicon.ico">Student Evaluation<h2> <br>

              <span class="star-rate1">Student Name: <?php echo $fname; ?></span>
              <span class="star-rate2">Student ID: <?php echo $student_id; ?></span> <br> <br>

              <table class="c-add-table" style="width: 95%;">
                  <tr>
                    <th>Student ID</th>
                    <th>Course Name</th>
                    <th>Add Rating</th>            
                      ...
                      <?php 
                        $c_sql = "SELECT * FROM student_course WHERE student_id = '$student_id' ";                        
                        $c_result = mysqli_query($data, $c_sql);
                        $c_info = mysqli_fetch_all($c_result);

                        foreach($c_info as $items)
                        {
                          $student_id = $items[0];
                          $fname = $items[1];
                          $class_id = $items[2];
                  ...
                  <tr>
                    ...
                    <td class="eval"><input type="range" class="slider" name="slider<?php echo "{$items[3]}";?>" <?php echo 'id="'; echo "{$items[3]}"; echo '"'?> 
                       min=0 max=100 step=5 value=0>
                        
                      <span id="p_rating<?php echo "{$items[3]}";?>"></span>

                    </td>

                    <script>
                        var slider = document.getElementById("<?php echo "{$items[3]}"; ?>");
                        var output = document.getElementById("<?php echo "p_rating"; echo"{$items[3]}";?>");
                        output.innerHTML = slider.value;
                        slider.oninput = function()
                        {                        
                          document.getElementById("<?php echo "p_rating"; echo"{$items[3]}";?>").innerHTML = this.value;
                          document.getElementById("<?php echo "p_rating"; echo"{$items[3]}";?>").value = this.value;
                        }
                    </script>
              ...
              <button type="submit" name="sub" class="add">confirm
                <span class="tooltiptext">Submit Student Rating !</span>
              </button>
                ...
                <?php
                  if (isset($_POST['sub']))
                  {
                    foreach ($c_info as $items)
                    {
                      $std_id="{$items[0]}";
                      $course_id = "{$items[3]}";
                      $p_rating="slider"."{$items[3]}";
                      
                      $std_p_rating=$_POST[$p_rating];
                      $std_p_rating=strval($std_p_rating);
                      $std_query=mysqli_query($data,"UPDATE student_course SET p_rating = '$std_p_rating' WHERE student_id = '$std_id' and course_id = '$course_id' ");                                             
                      if($std_query)
                        {
