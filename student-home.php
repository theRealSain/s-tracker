      ...
      <div class="layout-container">
        ...
        <h1 class="welcome"> Welcome <?php echo "{$info['fname']}" ?> </h1>
          ...
          <div class="dash-cards">
            ...
            <a href="student-mark.php">
              <div class="card">
                ...
                <svg id="svg-home" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width=22 fill=#566A7F>
                  ...
                  Your Marks</h1>
                <img class="marks" src="z_marks.png">
              </div>
            </a>
            ...
            <a href="student-evaluation.php">
              <div class="card">
                <h1 class="layout-head">&emsp;&emsp;
                <svg id="svg-home" class="eval-svg-main" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 192 512" width=15 fill=white>
                  <path d="M48 80a48 48 0 1 1 96 0A48 48 0 1 1 48 80zM0 224c0-17.7 14.3-32 32-32H96c17.7 0 32 14.3 32 32V448h32c17.7 0 32 14.3 32 32s-14.3 32-32 32H32c-17.7 0-32-14.3-32-32s14.3-32 32-32H64V256H32c-17.7 0-32-14.3-32-32z"/>
                </svg>
                  Student Evaluation</h1>
                <img class="info" src="z_info.png">
              </div>
            </a>
