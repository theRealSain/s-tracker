      ...
      <div class="layout-container">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item">
              <a href="parent-mark.php" class="menu-link" id="active-side-menu">
          ...
          <section class="course-student">
            <form action="#" method="POST">
              <div class="studentview" style="margin: 40px 0px 80px 120px; width: 95%">
                ...
                <span class="in-crs">Student Name: <?php echo $fname; ?></span>

                <table class="c-add-table" style="width: 95%; margin-top: 20px;">
