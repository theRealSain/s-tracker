...
$chat_display = "SELECT * FROM parent_feedback WHERE teacher_id = '$id' ";

$chat_display_result = mysqli_query($data, $chat_display);

$chat_display_info = mysqli_fetch_all($chat_display_result);
      ...
      <div class="layout-container">
        ...
        <div class="layout-page">
          ...
          <form action="" method="POST">
            ...
            <div class="chat">                
              <h3 class="chat-head">Incoming messages</h3>
                ...
                <ul class="chat-container">
                          ...
                          <?php
                            foreach($chat_display_info as $parent)
                            {
                              $p_id = $parent[0];
                              $message = $parent[2];

                              $p_sql = "SELECT * FROM parent_table WHERE id = '$p_id' ";

                              $p_result = mysqli_query($data, $p_sql);

                              $p_info = mysqli_fetch_all($p_result);

                              foreach($p_info as $pid)
                              {
                                $fname = $pid[0];
                                $parent_id = $pid[2];
                    ...
                    <li class="box3 sb14"  id="left">
                      <span class="msglabel">

                        From: <?php echo "<a href='teacher-parent-profile.php?id={$pid[2]}' style='color: inherit;'>"; ?>
                        <?php echo "{$parent[0]}"; ?>
                        </a>
                      </span><br>
                      <p class="msg-main"><?php echo "{$parent[2]}" ?><p> 
                    </li>
