...
$phone = $a_info['phone'];
$admin_id = $a_info['id'];
$class_id = $a_info['class_id'];
$college_id = $a_info['college_id'];
              ...
              <div class="profile-table">
                ...
                <table border=0>
                  <tr>
                    ...
                    <td class="profile-table-value2"><?php echo "$aname"; ?></td>
                  </tr>

                  <tr>
                    <td class="profile-table-value1">Account Type:</td>
                    <td class="profile-table-value2">Admin</td>
                  </tr>

                  <tr>
                    <td class="profile-table-value1">Admin ID:</td>
                    <td class="profile-table-value2"><?php echo "$admin_id"; ?></td>
                  </tr>

                  <tr>
                    <td class="profile-table-value1">Class ID:</td>
                    <td class="profile-table-value2"><?php echo "$class_id"; ?></td>
                  </tr>

                  <tr>
                    <td class="profile-table-value1">College ID:</td>
                    <td class="profile-table-value2"><?php echo "$college_id"; ?></td>
                  </tr>

                  <tr>
                    <td class="profile-table-value1">Phone:</td>
                    <td class="profile-table-value2"><?php echo "$phone"; ?></td>
                  </tr>
                </table>

                <button class="add" id="ad-pf-up"><a href="parent-teachers.php">back</a></button>
