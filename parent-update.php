...
if(isset($_POST['update']))
{
   ...
   $query = "UPDATE parent_table SET fname='$fname', id='$parent_id', password='$password', phone='$phone' WHERE id='$parent_id' ";
      ...
      <div class="layout-container">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item">
              <a href="parent-profile.php"class="menu-link" id="active-side-menu">
            ...
            <div class="profile-page">
              ...
              <div class="profile-table">
                ...
                <table border=0>
                  ...
                  <tr>
                    <td class="profile-table-value1">Parent ID:</td>
                  ...
                  <tr>
                    ...
                    <td class="profile-table-value2"><input class="form-control" id="update-text" type="text" name="student_id" value="<?php echo "{$info['student_id']}"; ?>" required></td>
                  </tr>
                </table>
                
                  <button class="add" id="ad-pf-lg"><a href="parent-profile.php">back</a>
                  <span class="tooltiptext">Go back!</span></button>
