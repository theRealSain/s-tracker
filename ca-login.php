            ...
            <div class="card-body">
              ...
              <div class="app-brand justify-content-center">
                <a href="login-options.php" class="app-brand-link gap-2">
                  ...
                  <img src="Images/favicon.ico" width=30>
              ...
              <form id="formAuthentication" class="mb-3" action="ca-validation.php" method="POST">
                <div class="mb-3">
                ...
                <span class="reg">Don't have an account? <a href="ca-reg.php">Sign Up</a></span><br>
