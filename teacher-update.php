...
if(isset($_POST['update']))
{
   ...
   $query = "UPDATE teacher_table SET fname='$fname', id='$id', phone='$phone', password='$password', college_id='$college_id' WHERE id='$id' ";
   ...
   {
    $_SESSION['xmessage'] = 'Failed to update your profile!';
    header("location:teacher-profile.php");
   }
      ...
      <div class="layout-container">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item">
              <a href="teacher-profile.php"class="menu-link" id="active-side-menu">
              ...
              <div class="profile-table">
                ...
                <table border=0>
                  <tr>
                    ...
                    <td class="profile-table-value2"><input class="form-control" id="update-text" type="text" name="fname" value="<?php echo "{$info['fname']}"; ?>" required></td>
                  </tr>

                  <tr>
                    <td class="profile-table-value1">Teacher ID:</td>
                    <td class="profile-table-value2"><input class="form-control" id="update-text" type="text" name="id" value="<?php echo "{$info['id']}"; ?>" required></td>
                  </tr>

                  <tr>
                    <td class="profile-table-value1">College ID:</td>
                    <td class="profile-table-value2"><input class="form-control" id="update-text" type="text" name="college_id" value="<?php echo "{$info['college_id']}"; ?>" required></td>
                  </tr>

                  <tr>
                    <td class="profile-table-value1">Password:</td>
                    <td class="profile-table-value2"><input class="form-control" id="update-text" type="text" name="password" value="<?php echo "{$info['password']}"; ?>" required></td>
                  </tr>

                  <tr>
                    <td class="profile-table-value1">Phone:</td>
                    <td class="profile-table-value2"><input class="form-control" id="update-text" type="text" name="phone" value="<?php echo "{$info['phone']}"; ?>" required></td>
                  </tr>              
                </table>
                
                  <button class="add" id="ad-pf-lg"><a href="teacher-profile.php">back</a>
                    <span class="tooltiptext">Go back!</span>
                  </button>
                  <button type="submit" id="ad-pf-up" class="add" name="update">save
