...
$stc_sql = "SELECT * FROM student_course WHERE student_id = '$id' ";
      ...
      <div class="layout-container">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item">
              <a href="student-performance.php" class="menu-link" id="active-side-menu">
        ...
        <div class="layout-page">
          ...
          <section class="profile-area">
            <div class=>
              ...
              <div class="profile-area-details">
                <span class="detail"><b>Name:</b> <?php echo "{$info['fname']}" ?></span>
                <span class="detail"><b>Student ID:</b> <?php echo "{$info['id']}" ?></span>
                <span class="detail"><b>Phone:</b> <?php echo "{$info['phone']}" ?></span>
                <span class="detail"><b>Gender:</b> <?php echo "{$info['gender']}" ?></span>
                <span class="detail"><b>Date of Birth:</b> <?php echo "{$info['dob']}" ?></span>
              </div>
            </div>
          </section>
          ...
          <section class="std-details-area">
            ...
            <span class="span1">Name: <?php echo "{$info['fname']}" ?></span>
            <span class="span2">Student ID: <?php echo "{$info['id']}"; ?></span>
            ...
            <select class="form-control" id="course-dropdown" name="graph_form" onchange="this.form.submit()">
                ...
                <?php
                  if (isset($_POST['graph_form'])) 
                  {
                    ...
                    $graph_sql = "SELECT * FROM student_course WHERE student_id = '$id' AND course_id = '$selected_course_id';";
          ...
          <div class="printing" id="print-button">print report</div>
          ...
          <script>
            ...
            printButton.addEventListener("click", function() {
              // Call the window.print() function to initiate the print action
              window.print();
            });
          </script>
