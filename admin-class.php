...
$phone = $cl_info['phone'];
$id = $cl_info['id'];
$password = $cl_info['password'];
$class_name = $cl_info['class_name'];
$class_id = $cl_info['class_id'];
$college_id = $cl_info['college_id'];
                ...
                <div class="table-responsive text-nowrap">
                  <table class="table table-hover">
                    ...
                    <tbody class="table-border-bottom-0">
                      ...
                      ?>
                      <tr>
                        <td><?php echo "<a href='admin-st-profile.php?id={$student_id}'>$student_id</a>"; ?>
