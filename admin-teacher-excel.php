      ...
      <div class="layout-container">
        ...
        <div class="layout-page">
          ...
          <section class="class-teachers">
            <form action="admin-tExcel.php" method="POST" enctype="multipart/form-data">
              <div class="contain">
                <h1 class="contain-head"><img src="Images/favicon.ico">create teachers</h1>
                <p class="file-para">
                  Create a group of teachers by uploading file. <br>
                  Allowed formats:
                </p>
                    <ul class="file-list">
                      <li>.xlsx</li>
