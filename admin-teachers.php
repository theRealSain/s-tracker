...
$t_sql = "SELECT * FROM teacher_table WHERE college_id = '$college_id'";
$t_result = mysqli_query($data, $t_sql);
$t_info = mysqli_fetch_all($t_result);


$teacher_count_sql = "SELECT COUNT(*) FROM teacher_table WHERE college_id = '$college_id' ";
$teacher_count_result = mysqli_query($data, $teacher_count_sql);
$teacher_count_info = mysqli_fetch_array($teacher_count_result);
$teacher_count = $teacher_count_info[0];
      ...
      <div class="layout-container">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item">
              <a href="admin-teachers.php" class="menu-link" id="active-side-menu">
        ...
        <div class="layout-page">
          ...
          <section class="class-teachers">
            <div class="contain">
              <h1 class="contain-head"><img src="Images/favicon.ico">manage teachers</h1>
              <div class="add-class">
              ...
              <div class="row mb-5" >
                <div class="col-md-6 col-lg-4" id="class-cover">
                  <div class="card mb-3" id="class-blocks">
                    <div class="card-body">
                      <h5 class="card-title">Add a teacher</h5>
                      <p class="card-text">Add a single teacher by inputting various fields given in a popup.</p>
                ...
                <div class="col-md-6 col-lg-4" id="class-cover">
                  <div class="card mb-3" id="class-blocks">
                    <div class="card-body">
                      ...
                      <p class="card-text">Add a group of teachers by uploading files like .xlsx, .csv, .xls, etc.</p>
                      <a href="admin-teacher-excel.php" class="btn btn-primary">GO</a>
                    </div>
                  </div>
                </div>  
              </div>
                        ...
                        <div class="modal-dialog" role="document">
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              ...
                              <div class="row">
                                <div class="col mb-3">
                                  <label for="nameBasic" class="form-label">Teacher Name</label>
                                  <input type="text" id="nameBasic" class="form-control" placeholder="Enter Teacher Name" name="fname" required/>
                                </div>
                              </div>

                              <div class="row">
                                <div class="col mb-3">
                                  <label for="idBasic" class="form-label">Teacher ID</label>
                                  <input type="text" id="idBasic" class="form-control" placeholder="Enter Teacher ID" name="id" required/>                                  
                                </div>
                              </div>
                    ...
                    <?php
                      if(isset($_POST['add-teacher']))
                      {
                        ...
                        $check_user = mysqli_query($data,$check);
                         ...
                         $sql = "INSERT INTO teacher_table(fname, phone, id, password, college_id) VALUES('$fname', '$phone', '$id', '$password', '$college_id')";
                         $result = mysqli_query($data, $sql);

                         if($result)
                         {
                            $_SESSION['teacher-add'] = 'Teacher Added Succesfully! Please reload the page!';
                            header("location:admin-teachers.php");
                         }
                         else
                         {
                             $_SESSION['no_teacher-add'] = 'Failed to add teacher. Try again!';
                             header("location:admin-teachers.php");
                         }
                      }
            ...
            <div class="card">
              ...
              ?>
                ...
                <h5 class="card-header">List of Teachers(<?php echo "$teacher_count"; ?>)</h5>
                <div class="table-responsive text-nowrap">
                  <table class="table table-hover">
                    <thead class="class">
                      <tr>
                        <th class="class">Teacher</th>                        
                        <th class="class">Teacher ID</th>
                    ...
                    ?>
                      ...
                      <tr>
                        <td><?php echo "<a href='admin-t-profile.php?id={$teacher_id}'>$fname</a>"; ?>                        
                        <td><?php echo $teacher_id; ?></td>
                        <td><?php echo $phone; ?></td>
                        <td><?php echo $college_name; ?></td>
                        <td>  
                        <?php 
                          echo "<a onClick=\" javascript:return confirm('Are you sure to delete this teacher?')\" href='admin-teacher-delete.php?id={$teacher[2]}'>
