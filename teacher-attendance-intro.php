        ...
        <div class="layout-page">
          ...
          <section class="class-teachers">
            <form action="" method="POST" id="course_form">
              <div class="contain">
                <h1 class="contain-head"><img src="Images/favicon.ico">Student Evaluation</h1>
                <h1 class="eval-subhead">get started</h1>

                <p class="eval-desc">Dear <?php echo "{$info['fname']}" ?>,</p>
                <p class="eval-desc">
                  This system aims to predict a student's marks by making use of various parameters. One of the main parameters for this prediction is the attendance
                  of students. This feature allows you to efficiently track and manage student attendance for various courses and classes. Monitor attendance 
                  records, identify patterns, and ensure accurate record-keeping. You can easily view attendance records for each student and session. The system 
                  provides a detailed summary about students who are absent in a session. <br><br>
                  
                  To take attendance, simply select the course or class from the popup menu. You can then mark students as 'Present' or 'Absent' 
                  for the current session. You can edit the attendance in the atendance history section.
                </p>
                        
                <button type="button" class="btn btn-primary eval-btn" data-bs-toggle="modal" data-bs-target="#modalCenter">Add Attendance</button>

                <div class="modal fade" id="modalCenter" tabindex="-1" aria-hidden="true">
                  <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                      <div class="modal-header">
                        <h5 class="modal-title" id="modalCenterTitle">Courses</h5>
                        <button
                          type="button"
                          class="btn-close"
