            ...
            <div class="profile-page">
              ...
              <div class="profile-table">
                ...
                <table border=0>
                  ...
                  <tr>
                    <td class="profile-table-value1">Account Type:</td>
                    <td class="profile-table-value2">Parent</td>
                  </tr>
                  ...
                  <tr>
                    ...
                    <td class="profile-table-value2"><?php echo "{$info['student_id']}" ?></td>
                  </tr>
                </table>

                <span class="parent-student" id="std-pf"><a href="parent-student-profile.php">Student Profile</a>
                  <span class="tooltiptext" style="margin-top: -100px;">View student profile!</span>
                </span>
                
                <button class="add" id="ad-pf-up" style="margin: 15px 50px 0px 0px;"><a href="parent-update.php">update</a>
                ...
                <div class="demo-inline-spacing">
                  <button type="button" class="add" id="ad-pf-lg" data-bs-toggle="modal" data-bs-target="#modalScrollable">LOG OUT</button>
                      ...
                      <div class="mt-3">
                        <button type="button" data-bs-toggle="modal" data-bs-target="#modalToggle" style="color: darkred; border: none; margin: auto; display: block;">
                        <svg style="margin-right: 10px;" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" width=14 fill=darkred>
                        ...
                        >
                          <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                              <div class="modal-header">
                                <h5 class="modal-title" id="modalToggleLabel">Alert!</h5>
                                <button
                                  type="button"
                                  class="btn-close"
                                  data-bs-dismiss="modal"
                              ...
                              <div class="modal-body">Contact Class Admin of your child to Deactivate your Account</div>
                              <div class="modal-footer">
                                
                                <button class="btn btn-primary" data-bs-target="#modalToggle2" data-bs-toggle="modal" data-bs-dismiss="modal">
                                  <a href="parent-teachers.php" style="color: white;">Reach Class Admin</a>
                                </button>
