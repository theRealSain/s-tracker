...
>
  <head>
    ...
    <title>S-Tracker-Teacher Login</title>
        ...
        <div class="authentication-inner">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <!-- /Logo -->
              <h4 class="mb-2"><b>Teacher Login</b></h4>
              <p class="mb-4">Please sign-in to your account and start the adventure</p>

              <form id="formAuthentication" class="mb-3" action="teacher-validation.php" method="POST">
                <div class="mb-3">
                  <label for="teacher_id" class="form-label">Teacher ID</label>
                  <input type="text" class="form-control" id="email" name="id"
                    placeholder="Enter Teacher ID" autofocus required>
                </div>
