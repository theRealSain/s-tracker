      ...
      <div class="layout-container">
        ...
        <div class="layout-page">
          ...
          <section class="class-teachers">
            <form action="ca-sExcel.php" method="POST" enctype="multipart/form-data">
              <div class="contain">
                <h1 class="contain-head"><img src="Images/favicon.ico">add students</h1>
                <p class="file-para">
                  Add a group of students by uploading file. <br>
                  Allowed formats:
                </p>
                    <ul class="file-list">
                      <li>.xlsx</li>
                    ...
                    <a href="Excel/Students_template.xlsx" download><span class="template-dwn">Download Template</span></a> <br>
                ...
                <div class="input-group" id="inp-grp">
                  ...
                  <button class="btn btn-outline-primary" type="submit" name="save_excel_data" id="inputGroupFileAddon04">Submit</button>
                </div>

                        <?php
                          if($_SESSION['std-excel'])
                          {
