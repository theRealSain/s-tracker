          ...
          <section class="class-teachers">
            <form action="" method="POST" id="course_form">
              <div class="contain">
                ...
                <p class="eval-desc">
                  This system aims to predict a student's marks by making use of various parameters. One of the main parameters for this prediction is the evaluation of students 
                  by giving a rating to each and every students under each course. Each student is rated based on their performance in the class like,
                  effective communication with teachers, contribution to class discussions, etc.<br><br>

                  To add evaluation, simply select the course or class from the popup menu. You can then rate students out of 100.
                  You can update the rating in the same page.
                </p>
                        
                <button type="button" class="btn btn-primary eval-btn" data-bs-toggle="modal" data-bs-target="#modalCenter">Evaluate Students</button>
                    ...
                    <div class="modal-content">
                      ...
                      <?php                          
                       ...
                       <?php
                          ...
                          echo"
                          <a href='teacher-evaluation.php?id=$course_id' style='color: inherit;'>";
                       ?>
                           <div class="row">
                             <div class="col mb-3">
