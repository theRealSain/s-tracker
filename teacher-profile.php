          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item">
              <a href="teacher-profile.php"class="menu-link" id="active-side-menu">
                <svg class="active-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width=16>
            ...
            <div class="profile-wrapper">
              <div class="profile-card">
                ...
                if(isset($_POST['update']))
                {
                   ...
                   $query = "UPDATE teacher_table SET fname='$fname', phone='$phone', id='$teacher_id', password='$password', college_id='$college_id' WHERE id='$id' ";
                ...
                <form method="POST" action="teacher-profile-picture.php"name="profile-pic" enctype="multipart/form-data">
