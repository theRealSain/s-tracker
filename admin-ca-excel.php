      ...
      <div class="layout-container">
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item">
              <a
                ...
                <svg class="side-icons" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width=18 fill=gray>
        ...
        <div class="layout-page">
          ...
          <section class="class-teachers">
            <form action="admin-cExcel.php" method="POST" enctype="multipart/form-data">
              <div class="contain">
                <h1 class="contain-head"><img src="Images/favicon.ico">create classrooms</h1>
                <p class="file-para">
                  Create a group of classrooms by uploading file. <br>
                  Allowed formats:
                </p>
                    <ul class="file-list">
                      <li>.xlsx</li>
                    ...
                    <p class="file-para">
                      Download the template file for uploading data using excel files. Input data in the template file and upload here!
                      <a href="Excel/Classroom_template.xlsx" download><span class="template-dwn">Download Template</span></a> <br>
                      <span style="color: red">
                        *Don't try to make changes in the order of columns. It may cause errors in the system! <br>
                      </span>
                    </p> 

                    

                    <div class="input-group" id="inp-grp">
                      <input type="file" class="form-control" id="inputGroupFile04" name="import_file" aria-describedby="inputGroupFileAddon04" aria-label="Upload">
                      <button class="btn btn-outline-primary inp-grp-btn" type="submit" name="save_excel_data" id="inputGroupFileAddon04">Submit</button>
                    </div>
                    
                        <?php
                          if($_SESSION['class-excel'])
                          {
                            echo "<div class='alert alert-success alert-dismissible' role='alert' id='alert_toast' style='font-size: 1rem; margin-top: 10px'>"
                            .$_SESSION['class-excel'].
                            "<button type='button' class='btn-close' data-bs-dismiss='alert' aria-label='Close'></button>
                          </div>";
                          }
                          unset($_SESSION['class-excel']);
                        ?>

                        <?php
                          if($_SESSION['class-excel-err'])
                          {
                            echo "<div class='alert alert-danger alert-dismissible' role='alert' id='alert_toast' style='font-size: 1rem; margin-top: 10px'>"
                            .$_SESSION['class-excel-err'].
                            "<button type='button' class='btn-close' data-bs-dismiss='alert' aria-label='Close'></button>
                          </div>";
                          }
                          unset($_SESSION['class-excel-err']);
                        ?>
              </div>
            </form>
          </section>
