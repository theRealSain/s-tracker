...
$sql = "SELECT * FROM class_admin WHERE id = '$id' ";
      ...
      <div class="layout-container">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item active">
              <a href="ca-home.php" class="menu-link">
            ...
            <li class="menu-item">
              <a href="ca-class.php" class="menu-link">
              <svg class="performance" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" width=18 fill=white>
                ...
                <div data-i18n="Basic">My Classroom</div>
              </a>
            </li>    

            <li class="menu-item">
              <a href="ca-students.php" class="menu-link" id="active-side-menu">
            ...
            <li class="menu-item">
              <a href="ca-courses.php" class="menu-link">
                ...
                <div data-i18n="Boxicons">Manage Courses</div>
              </a>
            </li>
            ...
            <li class="menu-item">
              <a href="ca-profile.php"class="menu-link">
        ...
        <div class="layout-page">
          ...
          <section class="class-teachers">
            <div class="contain">
              <h1 class="contain-head"><img src="Images/favicon.ico">manage students</h1>
              <div class="add-class">                  

              <div class="row mb-5" >
                <div class="col-md-6 col-lg-4" id="class-cover">
                  <div class="card mb-3" id="class-blocks">
                    <div class="card-body">
                      <h5 class="card-title">Add a student</h5>
                      <p class="card-text">Add a single student by inputting various fields given in a popup.</p>
                      <a href="javascript:void(0)" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#basicModal">GO</a>
                    </div>
                  </div>
                </div>
                <div class="col-md-6 col-lg-4" id="class-cover">
                  <div class="card mb-3" id="class-blocks">
                    <div class="card-body">
                      ...
                      <p class="card-text">Add a group of students by uploading files like .xlsx, .csv, .xls, etc.</p>
                      <a href="ca-students-excel.php" class="btn btn-primary">GO</a>
                    </div>
                  </div>
                </div>  
              </div>  
                      ...
                      <div class="modal fade" id="basicModal" tabindex="-1" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                          <div class="modal-content">
                            ...
                            <div class="row">
                                <div class="col mb-3">
                                  <label for="nameBasic" class="form-label">Student Name</label>
                                  <input type="text" id="nameBasic" class="form-control" placeholder="Enter Student Name" name="fname" required/>
                                </div>
                              </div>

                              <div class="row">
                                <div class="col mb-3">
                                  <label for="idBasic" class="form-label">Student ID</label>
                                  <input type="text" id="idBasic" class="form-control" placeholder="Enter Student ID" name="student_id" required/>                                  
                                </div>
                              </div>
                              ...
                              <div class="row">
                                <div class="col mb-3">
                                  ...
                                  <input type="text" id="passBasic" class="form-control" placeholder="Enter Password" name="password" required/>
                                </div>
                              </div>
                              ...
                              <div class="row">
                                <div class="col mb-3">
                                  ...
                                  <input type="text" id="phBasic" class="form-control" placeholder="Enter Phone Number" name="phone" required/>
                                </div>
                              </div>

                              <div class="row">
                                <div class="col mb-3">
                                  <label for="phBasic" class="form-label">Gender</label> <br>
                                  <div class="btn-group" role="group" aria-label="Basic radio toggle button group" id="gender">
                                    ...
                                    <input type="radio" class="btn-check" name="gender" id="btnradio3" value="Others" />
                              ...
                              <div class="row">
                                <div class="col mb-3">
                                  <label for="phBasic" class="form-label">Date of Birth</label>
                                  <input type="date" id="phBasic" class="form-control" placeholder="Enter Date of Birth" name="dob" required/>
                                </div>
                              </div>
                              <div class="row">
                                <div class="col mb-3">
                                  <label for="phBasic" class="form-label">Class ID</label>
                                  <input type="text" id="phBasic" class="form-control" placeholder="Enter Class ID" name="class_id" value="<?php echo "$class_id"; ?>" />
                                </div>
                              </div>
                              ...
                              <div class="row">
                                <div class="col mb-3">
                                  ...
                                  <input type="text" id="cidBasic" class="form-control" placeholder="Enter College ID" name="college_id" value="<?php echo "$college_id"; ?>" />
                                </div>
                              </div>
                            </div>
                    ...
                    <?php
                      if(isset($_POST['add-student']))
                      {
                        ...
                        $college_id = $_POST['college_id'];
                         ...
                         $sql = "INSERT INTO student_table(fname, id, password, phone, gender, dob, class_id, college_id) VALUES('$fname', '$std_id', '$password', '$phone', '$gender', '$dob', '$cls_id', '$college_id')";
                         $result = mysqli_query($data, $sql);

                         if($result)
                         {
                            $_SESSION['student-add'] = 'Student Added Succesfully!';
                            header("location:ca-students.php");
                         }
                         else
                         {
                             $_SESSION['no-student-add'] = 'Failed to add student. Try again!';
                             header("location:ca-students.php");
                         }
                      }
                      ...
                      {
                        $check = "SELECT * FROM teacher_table where college_id = '$college_id'";
                        $check_user = mysqli_query($data,$check);
                        
                        $delete_sql = "DELETE FROM teacher_table where college_id = '$college_id'";
                        $delete = mysqli_query($data,$delete_sql);

                        if($delete)
                         {
                            $_SESSION['delete_all'] = 'All Teachers were deleted!';
                            header("location:admin-teachers.php");
                         }
                         else
                         {
                             $_SESSION['no_delete_all'] = 'Failed to delete teachers. Try again!';
                             header("location:admin-teachers.php");
                         }
                      }
                    ?>
              ...
              <?php
              if($_SESSION['student-add'])
              {
                echo "<div class='alert alert-success alert-dismissible' role='alert' id='alert_toast' style='font-size: 1rem; margin-top: 10px'>"
                .$_SESSION['student-add'].
                "<button type='button' class='btn-close' data-bs-dismiss='alert' aria-label='Close'></button>
              </div>";
              }
              unset($_SESSION['student-add']);

              if($_SESSION['no-student-add'])
              {
                echo "<div class='alert alert-danger alert-dismissible' role='alert' id='alert_toast' style='font-size: 1rem; margin-top: 10px'>"
                .$_SESSION['no-student-add'].
                "<button type='button' class='btn-close' data-bs-dismiss='alert' aria-label='Close'></button>
              </div>";
              }
              unset($_SESSION['no-student-add']);
            ...
            <div class="card">
              ...
              <?php
                if($_SESSION['teacher-delete'])
                {
                  echo "<div class='alert alert-danger alert-dismissible' role='alert' id='alert_toast' style='font-size: 1rem; margin-top: 10px'>"
                  .$_SESSION['class-delete'].
                  "<button type='button' class='btn-close' data-bs-dismiss='alert' aria-label='Close'></button>
                </div>";
                }
                unset($_SESSION['teacher-delete']);                
              ?>
                ...
                <div class="table-responsive text-nowrap">
                  <table class="table table-hover">
                    <thead class="class">
                      <tr>
                        <th class="class">Student Name</th>
                        <th class="class">Student ID</th>
                        <th class="class">Password</th>
                        <th class="class">Phone</th>
                        <th class="class">Gender</th>
                        <th class="class">Date of Birth</th>
                        <th class="class">Class ID</th>
                        <th class="class">College ID</th>
                    ...
                    <?php
                      $st_sql = "SELECT * FROM student_table WHERE class_id = '$class_id' ";
                      $st_result = mysqli_query($data, $st_sql);                    
                      $st_info = mysqli_fetch_all($st_result);                    
                    ...
                    ?>
                      ...
                      <tr>
                        ...
                        <td>  
                        <?php 
                          echo "<a onClick=\" javascript:return confirm('Are you sure to delete this student?')\" href='ca-student-delete.php?id={$student[1]}'>
                          <img class='delete' src='Images/z_delete.png'></a>";
                        ?>
                        </td>
                      </tr>
              ...
              <!--<button type="button" name="delete-all" class="del">Delete all</button>-->
              </form>   
            </div>
