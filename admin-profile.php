...
if(isset($_POST['update']))
{
   ...
   $query = "UPDATE admin_table SET fname='$fname', phone='$phone', admin_id='$a_id', password='$password', college_id='$college_id', college_name='$college_name' WHERE admin_id='$admin_id' ";
      ...
      <div class="layout-container">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item">
              <a href="admin-profile.php"class="menu-link" id="active-side-menu">
                <svg class="performance" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width=18 fill=#755dff>
          ...
          <section class="profile">
            <div class="profile-wrapper">
              <div class="profile-card">
                ...
                <div class="btn-group">
                  ...
                  <ul class="dropdown-menu">
                    ...
                    <li data-bs-toggle="modal" data-bs-target="#modalScrollable"><a class="dropdown-item" href="javascript:void(0);">Deactivate your account</a></li>
                    ...
                    <div class="modal-dialog" role="document">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          ...
                          <div class="row">
                            <div class="col mb-3">
                            <label for="idBasic" class="form-label">Admin ID</label>
                            <input type="text" id="idBasic" class="form-control" placeholder="You can't edit this!" name="admin_id"  value="<?php echo "{$info['admin_id']}" ?>"/>
                            </div>
                          </div>
                          ...
                          <div class="row">
                            <div class="col mb-3">
                              <label for="cnBasic" class="form-label">College Name</label>
                              <input type="text" id="cnBasic" class="form-control" placeholder="Edit College Name" name="college_name" required value="<?php echo "{$info['college_name']}" ?>"/>
                            </div>
                          </div>                                                        
                ...
                <form method="POST" action="admin-profile-picture.php"name="profile-pic" enctype="multipart/form-data">
                ...
                <div class="modal fade" id="modalScrollable" tabindex="-1" aria-hidden="true" style="margin: 300px 0px 0px 0px;">
                  <div class="modal-dialog modal-dialog-scrollable" role="document">
                    <div class="modal-content">
                      <div class="modal-header">
                        <h5 class="modal-title" id="modalScrollableTitle">Account Deactivation</h5>
                        <button
                          type="button"
                          class="btn-close"
                          data-bs-dismiss="modal"
                      ...
                      <div class="modal-body">
                        Are you sure you want to deactivate your account? It can't be undone!
                      </div>
                      <div class="modal-footer">
                        <button type="button" class="btn btn-outline-secondary" data-bs-dismiss="modal">
                          Close
                        </button>
                        <button type="button" class="btn btn-primary" name="deactivate" id="deactivate-btn">Deactivate</button>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                document.getElementById('deactivate-btn').addEventListener('click', function() {
                  ...
                  if (confirm("Are you sure you want to deactivate your account?")) {
                    ...
                    xhr.open('POST', 'admin-profile.php', true);
                    ...
                    xhr.onload = function() {
                      if (xhr.status === 200) {
                        ...
                        alert('Error: Failed to deactivate account.');
                      }
                    };
                    xhr.send('deactivate=1');
                  }
                });
              </script>
              ...
              if (isset($_POST['deactivate'])) {
                // Perform the account deletion process
                ...
                // Delete the record from the `class_admin` table using the specified ID
                ...
                if ($result->num_rows > 0)
                {
                  ...
                  if (!empty($profilePicturePath))
                  {
                    echo '<div class="profile-pic">
                              <img class="dp" src="' . $profilePicturePath . '" alt="Profile Picture">
                              <div class="overlay">
                                <div class="options">
                                  <a>
                  ...
                  {                    
                    echo '<div class="profile-pic"><img class="nodp" src="Images/nodp.png" alt="Default Profile Picture"></div>';
                  }
                }
                else
                {
              ...
              ?>
                ...
                <script>
                      function deleteProfilePicture()
                      {
                        if (confirm("Are you sure you want to remove the profile picture?"))
                        {
                          ...
                          var xhr = new XMLHttpRequest();
                          xhr.open("GET", "admin-dp-delete.php", true);
                ...
                <table class="table" id="profile-data">
                    ...
                    <tr><th></th></tr>
                    <tr><th>ID</th></tr>
                    <tr><td><?php echo "{$info['admin_id']}" ?></td</tr>
                    <tr><th></th></tr>
                    <tr><th>College</th></tr>
                    <tr><td><?php echo "{$info['college_name']}" ?></td></tr>
                  </table>
