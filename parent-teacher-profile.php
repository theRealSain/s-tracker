              ...
              <div class="profile-table">
                ...
                <table border=0>
                  <tr>
                    ...
                    <td class="profile-table-value2"><?php echo "{$t_info['fname']}" ?></td>
                  </tr>

                  <tr>
                    <td class="profile-table-value1">Teacher ID:</td>
                    <td class="profile-table-value2"><?php echo "{$t_info['id']}" ?></td>
                  </tr>
                  
                  <tr>
                    <td class="profile-table-value1">Phone:</td>
                    <td class="profile-table-value2"><?php echo "{$t_info['phone']}" ?></td>
                  </tr>
