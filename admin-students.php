      ...
      <div class="layout-container">
        ...
        <div class="layout-page">
          ...
          <form action="" method="POST" id="class_form">
            <div class="contain">
              <h1 class="contain-head"><img src="Images/favicon.ico">list of students</h1>

              <p class="students-intro">This section displays all the students of <?php echo $info['college_name']; ?> grouped by classes. 
                Choose a class from the dropdown below to view the list of students under each class. </p>

              <span class="class-select-label">Select a class here:</span>
              <select class="form-control" id="class-select" name="class_form" onchange="this.form.submit()">
                    <option selected hidden>Choose a classroom</option>
                    <?php

                      $c2_sql = "SELECT * FROM class_admin WHERE college_id = '$college_id' ";
                      ...
                      {                      
                        ...
                        echo "<option value='" . $class_id. "'>" . $row['class_name'] . "</option>";
                      }
                    ?> 
              </select>
                        ...
                        <?php
                          ...
                          {
                            $selected_class_id=$_POST['class_form'];

                            $st_sql = "SELECT * FROM student_table WHERE class_id = '$selected_class_id';";                            

                            $cla_sql = "SELECT * FROM class_admin WHERE class_id = '$selected_class_id' ";

                            $cla_result = mysqli_query($data, $cla_sql);

                            $cla_info = mysqli_fetch_assoc($cla_result);
                        ?>

                

                <div class="card">
                  <h5 class="card-header" id="class-head">Students of <?php echo $cla_info['class_name']; ?></h5>
                  <div class="table-responsive text-nowrap">
                    <table class="table table-hover">
                      ...
                      ?>
                        ...
                        <tr>
                          <td><?php echo "<a href='admin-st-profile.php?id={$student[1]}'>$student[1]</a>"; ?>
