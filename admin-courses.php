      ...
      <div class="layout-container">
        ...
        <div class="layout-page">
          ...
          <form action="" method="POST" id="class_form">
            <div class="contain">
              <h1 class="contain-head"><img src="Images/favicon.ico">list of courses</h1>


              <?php
              foreach($cl_info as $classes)
              {
                $class_id = $classes[5];
                ...
                foreach($c_info as $courses)
                {
                  ...
                  $cn_sql = "SELECT * FROM class_admin WHERE class_id = '$cl_id' ";
                  $cn_result = mysqli_query($data, $cn_sql);
                  $cn_info = mysqli_fetch_all($cn_result);

                  foreach($cn_info as $classname)
                  {
                    ...
                    foreach($tn_info as $teachername)
                    {
                      $teacher_name = $teachername[0];
                ?>

              <?php echo "
              <a href='admin-course-students.php?id=$course_id' style='color: inherit'>
              "; ?>
              ...
              <div class="course">
                ...
                <h1 class="course-head"><?php echo $cname; ?></h1>
