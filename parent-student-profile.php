              ...
              <div class="profile-table">
                ...
                <table border=0>
                  <tr>
                    ...
                    <td class="profile-table-value2"><?php echo "{$std_info['fname']}" ?></td>
                  </tr>

                  <tr>
                    <td class="profile-table-value1">Student ID:</td>
                    <td class="profile-table-value2"><?php echo "{$std_info['id']}" ?></td>
                  </tr>
                  
                  <tr>
                    <td class="profile-table-value1">Phone:</td>
                    <td class="profile-table-value2"><?php echo "{$std_info['phone']}" ?></td>
                  </tr>

                  <tr>
                    <td class="profile-table-value1">Gender:</td>
                    <td class="profile-table-value2"><?php echo "{$std_info['gender']}" ?></td>
                  </tr>

                  <tr>
                    <td class="profile-table-value1">Date of Birth:</td>
                    <td class="profile-table-value2"><?php echo "{$std_info['dob']}" ?></td>
                  </tr>
                </table>        

                <button class="add" id="ad-pf-up"><a href="parent-profile.php">back</a></button>
