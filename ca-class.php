      ...
      <div class="layout-container">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item">
              <a href="ca-class.php" class="menu-link" id="active-side-menu">
        ...
        <div class="layout-page">
          ...
          <section class="class-teachers">
            <div class="contain">
                <h1 class="contain-head"><img src="Images/favicon.ico"><?php echo "$class_name" ?></h1>
                <table class="table table-hover" id="classroom">
                    <tr>
                        <th>Class Teacher</th><td><?php echo "$fname";?></td>
                    </tr>
                    <tr>
                        <th>Phone</th><td><?php echo "$phone";?></td>
                    </tr>
                    <tr>
                        <th>Class Teacher ID</th><td><?php echo "$id";?></td>
                    </tr>
                    <tr>
                        <th>Class Name</th><td><?php echo "$class_name";?></td>
                    </tr>
                    <tr>
                        <th>Class ID</th><td><?php echo "$class_id";?></td>
                    </tr>  
                    <tr class="last-row">
                        <th>College Name</th><td><?php echo "$college_name";?></td>
                    </tr>
                </table>
                  <img class="class-img" src="Images/z_teacher.jpg">
                </div>


            <div class="class-table">
              <div class="card">
                <h5 class="card-header">Students of <?php echo "$class_name";?></h5>
