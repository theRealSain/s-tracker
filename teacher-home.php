...
$class_sql = "SELECT * FROM courses WHERE teacher_id = '$id' ";
$class_result = mysqli_query($data, $class_sql);
$class_info = mysqli_fetch_all($class_result);



$course_count_sql = "SELECT COUNT(*) FROM courses WHERE teacher_id = '$id' AND college_id = '$college_id' ";
$course_count_result = mysqli_query($data, $course_count_sql);
$course_count_info = mysqli_fetch_array($course_count_result);
$course_count = $course_count_info[0];


$crse_sql = "SELECT * FROM courses WHERE teacher_id = '$id' ";
$crse_result = mysqli_query($data, $crse_sql);
$crse_info = mysqli_fetch_all($crse_result);
        ...
        <div class="layout-page">
          ...
          <div class="layout-main">
                <div class="left-column">
                  ...
                  <div class="head-card">
                      <h1 class="welcome"> Welcome <?php echo "{$info['fname']}"; ?> </h1>
                      <p class="wel-text">Wishing a good day to you. Enjoy your day! Get started with s-tracker and start the adventure!</p>
                  </div>

                  <div class="main-cards">

                    <div class="cards1">
                        <a href="teacher-attendance-intro.php" id="card-link">
                            <div class="letter tAttend" id="left-card">
                              <h1 class="layout-head">&emsp;&emsp;
                              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" width=18 fill=#566A7F>
                                <path d="M224 256A128 128 0 1 0 224 0a128 128 0 1 0 0 256zm-45.7 48C79.8 304 0 383.8 0 482.3C0 498.7 13.3 512 29.7 512H418.3c16.4 0 29.7-13.3 29.7-29.7C448 383.8 368.2 304 269.7 304H178.3z"/>
                              </svg>  
                              Attendance</h1>
                              <span class="number">Total number of students:</span>

                              
                              <div class="card overflow-hidden" style="height: 130px">                                
                                <div class="card-body ps ps--active-x ps--active-y scroll" id="both-scrollbars-example scroll">
                                <p class="group-count">
                              
                                  <?php
                                  foreach($class_info as $classInfo)
                                  {
                                    $class_id = $classInfo[3];
                                  
                                    $student_count_sql = "SELECT COUNT(*) FROM student_course WHERE class_id = '$class_id' GROUP BY course_id;";
                                  ...
                                  <div class="ps__rail-x" style="width: 1388px; left: 0px; bottom: 0px;">                                  
                                    <div class="ps__thumb-x" tabindex="0" style="left: 0px; width: 980px;">
                                    </div>
                                  </div>
                                  <div class="ps__rail-y" style="top: 0px; height: 432px; right: 0px;">
                                    <div class="ps__thumb-y" tabindex="0" style="top: 0px; height: 143px;">
                                    </div>
                                  </div>
                                </div>
                              </div>
                              ...
                              <!--<img src="Images/z_attendance.png" class="attend">-->
                            </div>
                        </a>
                        <a href="teacher-mark-intro.php" id="card-link">
                            <div class="letter" id="right-card">
                              <h1 class="layout-head">&emsp;&emsp;
                              <svg style="width: 22px;" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512" fill=#566A7F>
                                <path d="M96 128a128 128 0 1 1 256 0A128 128 0 1 1 96 128zM0 482.3C0 383.8 79.8 304 178.3 304h91.4C368.2 304 448 383.8 448 482.3c0 16.4-13.3 29.7-29.7 29.7H29.7C13.3 512 0 498.7 0 482.3zM609.3 512H471.4c5.4-9.4 8.6-20.3 8.6-32v-8c0-60.7-27.1-115.2-69.8-151.8c2.4-.1 4.7-.2 7.1-.2h61.4C567.8 320 640 392.2 640 481.3c0 17-13.8 30.7-30.7 30.7zM432 256c-31 0-59-12.6-79.3-32.9C372.4 196.5 384 163.6 384 128c0-26.8-6.6-52.1-18.3-74.3C384.3 40.1 407.2 32 432 32c61.9 0 112 50.1 112 112s-50.1 112-112 112z"/>
                              </svg>  
                              Internal Marks</h1>   
                              <span class="number">Performance of students:</span><br>
                              <div class="card overflow-hidden" style="height: 130px">                                
                                <div class="card-body ps ps--active-x ps--active-y scroll" id="both-scrollbars-example scroll">
                                <p class="group-count">
                        ...
                        <a href="teacher-eval-intro.php" id="card-link">
                            <div class="letter" id="left-card">
                              <h1 class="layout-head">&emsp;&emsp;
                              <svg style="width: 22px;" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512" fill=#566A7F>
                                <path d="M96 128a128 128 0 1 1 256 0A128 128 0 1 1 96 128zM0 482.3C0 383.8 79.8 304 178.3 304h91.4C368.2 304 448 383.8 448 482.3c0 16.4-13.3 29.7-29.7 29.7H29.7C13.3 512 0 498.7 0 482.3zM609.3 512H471.4c5.4-9.4 8.6-20.3 8.6-32v-8c0-60.7-27.1-115.2-69.8-151.8c2.4-.1 4.7-.2 7.1-.2h61.4C567.8 320 640 392.2 640 481.3c0 17-13.8 30.7-30.7 30.7zM432 256c-31 0-59-12.6-79.3-32.9C372.4 196.5 384 163.6 384 128c0-26.8-6.6-52.1-18.3-74.3C384.3 40.1 407.2 32 432 32c61.9 0 112 50.1 112 112s-50.1 112-112 112z"/>
                              </svg>  
                              Student Evaluation</h1>
                              <span class="number">Evaluation of students:</span>
                              <div class="card overflow-hidden" style="height: 130px">                                
                                <div class="card-body ps ps--active-x ps--active-y scroll" id="both-scrollbars-example scroll">
                                <p class="group-count">
                                  Outstanding students: <br>
                        ...
                        <a href="teacher-courses.php" id="card-link">
                            <div class="letter" id="right-card">
                              <h1 class="layout-head">&emsp;&emsp;
                              <svg  xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" width=22 fill=#566A7F>
                                <path d="M249.6 471.5c10.8 3.8 22.4-4.1 22.4-15.5V78.6c0-4.2-1.6-8.4-5-11C247.4 52 202.4 32 144 32C93.5 32 46.3 45.3 18.1 56.1C6.8 60.5 0 71.7 0 83.8V454.1c0 11.9 12.8 20.2 24.1 16.5C55.6 460.1 105.5 448 144 448c33.9 0 79 14 105.6 23.5zm76.8 0C353 462 398.1 448 432 448c38.5 0 88.4 12.1 119.9 22.6c11.3 3.8 24.1-4.6 24.1-16.5V83.8c0-12.1-6.8-23.3-18.1-27.6C529.7 45.3 482.5 32 432 32c-58.4 0-103.4 20-123 35.6c-3.3 2.6-5 6.8-5 11V456c0 11.4 11.7 19.3 22.4 15.5z"/>
                              </svg>  
                              Courses</h1>
                              <span class="number">Number of Courses:</span><br>
                              <span class="n"><?php echo $course_count; ?></span>
                              <img src="Images\course.png" class="courses">
                            </div>
                        </a>
                    </div>
                  </div>
                ...
                <div class="cards2">
                  <a href="teacher-profile.php" class="p-hyp">
                      <div class="pletter">
                          <h1 class="layout-head" style="margin-bottom: 30px;">&emsp;&emsp;
                          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width=22 fill=#566A7F>
                              <path d="M399 384.2C376.9 345.8 335.4 320 288 320H224c-47.4 0-88.9 25.8-111 64.2c35.2 39.2 86.2 63.8 143 63.8s107.8-24.7 143-63.8zM0 256a256 256 0 1 1 512 0A256 256 0 1 1 0 256zm256 16a72 72 0 1 0 0-144 72 72 0 1 0 0 144z"/>
                          </svg>
                          Profile</h1>

                          <img src="Images/z_profile.jpg" class="prof">
