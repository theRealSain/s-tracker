      ...
      <div class="layout-container">
        ...
        <div class="layout-page">
          ...
          <?php
                        ...
                        $ct_id = $_GET['id'];
                        $ct_sql = "SELECT * FROM class_admin WHERE id = '$ct_id'"; 
                        $ct_result = mysqli_query($data, $ct_sql);
                        $ct_info = mysqli_fetch_assoc($ct_result);
                        $ctname = $ct_info['fname'];
                        $clname = $ct_info['class_name'];
                        $clid = $ct_info['class_id'];
                        $phn = $ct_info['phone'];
            ...
            <div class="contain" style="">
                ...
                <div class="sub-profile-grid">
                    ...
                    <div class="sub-profile-card">
                      <?php
                        $sql = "SELECT profile_picture FROM student_table WHERE id = '$ct_id'";
                        $result = $data->query($sql);
                        if ($result->num_rows > 0)
                        {
                          $row = $result->fetch_assoc();
                    ...
                    <div class="sub-profile-card sub-details">
                      <div class="sub-details-1">
                        <span class="sub-profile-label1">Class Teacher Name</span>
                        <span class="sub-profile-label2"><?php echo "$ctname";?> </span>
                        
                        <span class="sub-profile-label1">Class Name</span>
                      ...
                      <span class="sub-profile-label1">Username</span>
                        <span class="sub-profile-label2"><?php echo "$ct_id";?>   </span>

                        <span class="sub-profile-label1">Class ID</span>
                        <span class="sub-profile-label2"><?php echo "$clid";?>  </span>
