...
$class_id = $s_info['class_id'];

########################################

$a_sql = "SELECT * FROM class_admin WHERE class_id = '$class_id' ";

$a_result = mysqli_query($data, $a_sql);

$a_info = mysqli_fetch_assoc($a_result);
      ...
      <div class="layout-container">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item">
              <a href="parent-teachers.php" class="menu-link" id="active-side-menu">
        ...
        <div class="layout-page">
          ...
          <section class="course-student">
            <form action="" method="POST">
              <div class="studentview" style="margin: 120px 0px 80px 120px; width: 80%">
                ...
                LIST OF TEACHERS<h1>
                      ...
                      <?php
                        ...
                        foreach($sc_info as $items)
                        {
                          ...
                          $st_sql = "SELECT * FROM courses WHERE id = '$course_id' ";

                          $st_result = mysqli_query($data, $st_sql);

                          $st_info = mysqli_fetch_all($st_result);

                          foreach($st_info as $c_teach)
                            {
                              $teacher_id = $c_teach[2];
                            }
                      ...
                      <li>
                          ...
                          <?php
                            echo "<a href='parent-admin-profile.php?class_id=$class_id' style='color: inherit;'>";                                              
                          ?>
                          
                            <h3 class="s-head">Class Admin: <?php echo "$aname"; ?></h3>
                          </a>

                          <p style="font-size: 1.5rem;">
                            <?php
                              echo "Class ID: $class_id &emsp;";
                            }
                            ?>
                          </p>
                      </li>
                      ...
                      <ul class="s-course-list">                      
                        <li>
                          ...
                          <?php
                            echo "<a href='parent-teacher-profile.php?id={$teach[2]}' style='color: inherit;'>";                                              
                          ?>
                          
                            <h3 class="s-head"><?php echo "{$teach[0]}"; ?></h3>
                          </a>

                          <p style="font-size: 1.5rem;">
                            <?php
                              echo "Course: {$items[4]} &emsp;";
                              echo "Course ID: {$items[3]}";
                            }
                            ?>
                          </p>
