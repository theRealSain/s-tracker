...
if(isset($_POST['update']))
{
   ...
   $query = "UPDATE student_table SET fname='$fname', id='$id', phone='$phone', gender='$gender', dob='$dob', password='$password', class_id='$class_id' WHERE id='$id' ";
              ...
              <div class="profile-table">
                ...
                <table border=0>
                  ...
                  <tr>
                    ...
                    <td class="profile-table-value2"><input class="form-control" id="update-text" type="text" name="gender" value="<?php echo "{$info['gender']}"; ?>" required></td>
                  </tr>

                  <tr>
                    <td class="profile-table-value1">Date of Birth:</td>
                    <td class="profile-table-value2"><input class="form-control" id="update-text" type="text" name="dob" value="<?php echo "{$info['dob']}"; ?>" required></td>
                  </tr>

                  <tr>
                    <td class="profile-table-value1">Class ID:</td>
                    <td class="profile-table-value2"><input class="form-control" id="update-text" type="text" name="class_id" value="<?php echo "{$info['class_id']}"; ?>" required></td>
                  </tr>
                </table>
                
                  <button class="add" id="ad-pf-lg"><a href="student-profile.php">back</a>
