...
$c_sql = "SELECT * FROM courses WHERE teacher_id = '$id' ";
      ...
      <div class="layout-container">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item">
              <a href="teacher-attendance.php" class="menu-link">
            ...
            <li class="menu-item">
              <a href="teacher-feedback.php" class="menu-link">
                ...
                <div data-i18n="Tables">Parent Feedback</div>
              </a>
            </li>
        ...
        <form action="" method="POST">
          ...
          <section class="details-area">
            ...
            <span class="span1">Teacher: <?php echo "{$info['fname']}" ?></span>
            ...
            <table border=1>
              <tr>
                <th>Name</th><td><?php echo "{$st_info['fname']}"; ?></td>
              </tr>
              <tr>
                <th>Student ID</th><td><?php echo "{$st_info['id']}"; ?></td>
              </tr>
              <tr>
            ...
            <span class="predict">Predicted score of <?php echo "{$st_info['fname']}"; echo " for {$c_info['cname']}: $prediction%"; ?>
            </span>
          ...
          <section class="graph-area">
            ...
            <span class="span1">Student Name: <?php echo "{$st_info['fname']}" ?></span>
            <span class="span2">Course: <?php echo "{$c_info['cname']}"; ?></span>
