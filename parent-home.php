      ...
      <div class="layout-container">
        ...
        <h1 class="welcome"> Welcome <?php echo "{$info['fname']}" ?> </h1>        
          ...
          <div class="dash-cards">
            ...
            <a href="parent-attendance.php">
              <div class="card" id="attenndance">
                <h1 class="layout-head">&emsp;&emsp;
                <svg id="svg-home" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" width=20 fill=#566A7F>
                  <path d="M224 256A128 128 0 1 0 224 0a128 128 0 1 0 0 256zm-45.7 48C79.8 304 0 383.8 0 482.3C0 498.7 13.3 512 29.7 512H418.3c16.4 0 29.7-13.3 29.7-29.7C448 383.8 368.2 304 269.7 304H178.3z"/>
              </svg>  
                Attendance</h1>
                <img class="attendance" src="z_attendance.jpg">
              </div>
            </a>

            <a href="parent-mark.php">
              <div class="card">
                <h1 class="layout-head">&emsp;&emsp;
                <svg id="svg-home" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width=22 fill=#566A7F>
                <path d="M256 512A256 256 0 1 0 256 0a256 256 0 1 0 0 512zM369 209L241 337c-9.4 9.4-24.6 9.4-33.9 0l-64-64c-9.4-9.4-9.4-24.6 0-33.9s24.6-9.4 33.9 0l47 47L335 175c9.4-9.4 24.6-9.4 33.9 0s9.4 24.6 0 33.9z"/>
              </svg>  
                Student Marks</h1>
                <img class="marklist" src="z_mark.jpg">
              </div>
            </a>          

            <a href="parent-eval-intro.php">
              <div class="card">
                <h1 class="layout-head">&emsp;&emsp;
                <svg id="svg-home" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" width=22 fill=#566A7F>
                  <path d="M316.9 18C311.6 7 300.4 0 288.1 0s-23.4 7-28.8 18L195 150.3 51.4 171.5c-12 1.8-22 10.2-25.7 21.7s-.7 24.2 7.9 32.7L137.8 329 113.2 474.7c-2 12 3 24.2 12.9 31.3s23 8 33.8 2.3l128.3-68.5 128.3 68.5c10.8 5.7 23.9 4.9 33.8-2.3s14.9-19.3 12.9-31.3L438.5 329 542.7 225.9c8.6-8.5 11.7-21.2 7.9-32.7s-13.7-19.9-25.7-21.7L381.2 150.3 316.9 18z"/>
                </svg>
                Student Evaluation</h1>
                <img class="eval" src="z_eval.jpg">
              </div>
            </a>

            <a href="parent-courses.php">
              <div class="card">
                <h1 class="layout-head">&emsp;&emsp;
                <svg id="svg-home"  xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" width=22 fill=#566A7F>
                  <path d="M249.6 471.5c10.8 3.8 22.4-4.1 22.4-15.5V78.6c0-4.2-1.6-8.4-5-11C247.4 52 202.4 32 144 32C93.5 32 46.3 45.3 18.1 56.1C6.8 60.5 0 71.7 0 83.8V454.1c0 11.9 12.8 20.2 24.1 16.5C55.6 460.1 105.5 448 144 448c33.9 0 79 14 105.6 23.5zm76.8 0C353 462 398.1 448 432 448c38.5 0 88.4 12.1 119.9 22.6c11.3 3.8 24.1-4.6 24.1-16.5V83.8c0-12.1-6.8-23.3-18.1-27.6C529.7 45.3 482.5 32 432 32c-58.4 0-103.4 20-123 35.6c-3.3 2.6-5 6.8-5 11V456c0 11.4 11.7 19.3 22.4 15.5z"/>
                ...
                Score Prediction</h1>
                <img class="student" src="z_students.jpg">
              </div>
            </a>
            
            

            <a href="parent-student-performance.php">
              <div class="card">
                <h1 class="layout-head">&emsp;&emsp;
                <svg id="svg-home" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" width=22 fill=#566A7F>
                  <path d="M160 80c0-26.5 21.5-48 48-48h32c26.5 0 48 21.5 48 48V432c0 26.5-21.5 48-48 48H208c-26.5 0-48-21.5-48-48V80zM0 272c0-26.5 21.5-48 48-48H80c26.5 0 48 21.5 48 48V432c0 26.5-21.5 48-48 48H48c-26.5 0-48-21.5-48-48V272zM368 96h32c26.5 0 48 21.5 48 48V432c0 26.5-21.5 48-48 48H368c-26.5 0-48-21.5-48-48V144c0-26.5 21.5-48 48-48z"/>
                </svg>  
                  Student Performance</h1>
                <img class="graph" src="z_graph.png">
              </div>
            </a>

            <a href="parent-profile.php">
              <div class="card">
                <h1 class="layout-head">&emsp;&emsp;
                <svg id="svg-home" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width=22 fill=#566A7F>
                  ...
                  Profile</h1>
                  <img class="profile" src="z_profile.jpg">
              </div>
            </a>
