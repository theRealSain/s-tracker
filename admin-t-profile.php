      ...
      <div class="layout-container">
        ...
        <div class="layout-page">
          ...
          <?php
                        ...
                        $t_id = $_GET['id'];
                        $t_sql = "SELECT * FROM teacher_table WHERE id = '$t_id'"; 
                        $t_result = mysqli_query($data, $t_sql);
            ...
            <div class="contain" style="">
                ...
                <div class="sub-profile-grid">
                    ...
                    <div class="sub-profile-card">
                      <?php
                        $sql = "SELECT profile_picture FROM student_table WHERE id = '$t_id'";
                        $result = $data->query($sql);
                        if ($result->num_rows > 0)
                        {
                          $row = $result->fetch_assoc();
                    ...
                    <div class="sub-profile-card sub-details">
                      <div class="sub-details-1">
                        <span class="sub-profile-label1">Teacher ID</span>
                        <span class="sub-profile-label2"><?php echo "$t_id";?> </span>
