...
>
  <head>
    ...
    <title>S-Tracker - Admin Login</title>
    ...
    <script src="files-login/config.js"></script>
  </head>
        ...
        <div class="authentication-inner">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <!-- /Logo -->
              <h4 class="mb-2"><b>Admin Login</b></h4>
              <p class="mb-4">Please sign-in to your account and start the adventure</p>

              <form id="formAuthentication" class="mb-3" action="admin-validation.php" method="POST">
                <div class="mb-3">
                  ...
                  <div class="input-group input-group-merge">
                    ...
                    <span class="input-group-text cursor-pointer"><i class="bx bx-hide"></i></span>
                        ...
                        <?php
                          ...
                          if($_SESSION['a-success'])
                          {
                            echo "<div class='alert alert-primary alert-dismissible' role='alert' id='alert_toast'>"
                            .$_SESSION['a-success'].
                            "<button type='button' class='btn-close' data-bs-dismiss='alert' aria-label='Close'></button>
                          </div>";
                          }
                          unset($_SESSION['a-success']);
                        ?>
                ...
                <span class="reg">Don't have an account? <a href="admin-reg.php">Sign Up</a></span><br>
