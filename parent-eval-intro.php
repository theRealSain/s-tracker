    ...
    <div class="layout-wrapper layout-content-navbar">
      <div class="layout-container">
        ...
        <div class="layout-page">
          ...
          <h1 class="eval-head"><img src="favicon.ico">student evaluation</h1>

          <h1 class="eval-subhead">get started</h1>

          <div class="eval-desc">
            <p>Dear <?php echo "{$info['fname']}" ?>,</p>
            ...
            by giving a rating to each and every students under each courses. Each student is rated based on conditions such as the time spent for studying each course at home 
            and other aspects related to each course. You should evaluate each student by rating based on the performance details of your child given in
            <a href="parent-student-performance.php">Student Performance</a> page and based on your experiences. 

            <br><br>
            
          </div>

            <button class="add"><a href="parent-evaluation.php" style="color: white">Add rating now</a></button>
        </section>
