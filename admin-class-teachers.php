      ...
      <div class="layout-container">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item">
              <a href="admin-class-teachers.php" class="menu-link" id="active-side-menu">
              <svg class="performance" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" width=18 fill=#755dff>
            ...
            <li class="menu-item">
              <a href="admin-students.php" class="menu-link">
              <svg class="performance" style="width: 19px;" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512" fill=white>
                <path d="M96 128a128 128 0 1 1 256 0A128 128 0 1 1 96 128zM0 482.3C0 383.8 79.8 304 178.3 304h91.4C368.2 304 448 383.8 448 482.3c0 16.4-13.3 29.7-29.7 29.7H29.7C13.3 512 0 498.7 0 482.3zM609.3 512H471.4c5.4-9.4 8.6-20.3 8.6-32v-8c0-60.7-27.1-115.2-69.8-151.8c2.4-.1 4.7-.2 7.1-.2h61.4C567.8 320 640 392.2 640 481.3c0 17-13.8 30.7-30.7 30.7zM432 256c-31 0-59-12.6-79.3-32.9C372.4 196.5 384 163.6 384 128c0-26.8-6.6-52.1-18.3-74.3C384.3 40.1 407.2 32 432 32c61.9 0 112 50.1 112 112s-50.1 112-112 112z"/>
              </svg>
        ...
        <div class="layout-page">
          ...
          <section class="class-teachers">
            <div class="contain">
              <h1 class="contain-head"><img src="Images/favicon.ico">manage classrooms</h1>
              <div class="add-class">
              ...
              <div class="row mb-5" >
                <div class="col-md-6 col-lg-4" id="class-cover">
                  <div class="card mb-3" id="class-blocks">
                    <div class="card-body">
                      <h5 class="card-title">Add a classroom</h5>
                      <p class="card-text">Create a single classroom by inputting various fields given in a popup.</p>
                ...
                <div class="col-md-6 col-lg-4" id="class-cover">
                  <div class="card mb-3" id="class-blocks">
                    <div class="card-body">
                      ...
                      <p class="card-text">Create a group of classrooms by uploading files like .xlsx, .csv, .xls, etc.</p>
                      <a href="admin-ca-excel.php" class="btn btn-primary">GO</a>
                    </div>
                  </div>
                </div>  
              </div>
                  ...
                  <div class="mt-3">
                        ...
                        <div class="modal-dialog" role="document">
                          <div class="modal-content">
                            <div class="modal-header">
                              <h5 class="modal-title" id="exampleModalLabel1">Add Classroom</h5>
                              <button
                                type="button"
                                class="btn-close"
                            ...
                            <div class="modal-body">
                              <div class="row">
                                <div class="col mb-3">
                                  <label for="nameBasic" class="form-label">Class Teacher Name</label>
                                  <input type="text" id="nameBasic" class="form-control" placeholder="Enter Class Teacher Name" name="fname" required/>
                                </div>
                              </div>

                              <div class="row">
                                <div class="col mb-3">
                                  <label for="idBasic" class="form-label">Class Teacher ID</label>
                                  <input type="text" id="idBasic" class="form-control" placeholder="Enter Class Teacher ID" name="id" required/>                                  
                                </div>
                              </div>
                              ...
                              <div class="row">
                                <div class="col mb-3">
                                  <label for="clidBasic" class="form-label">Class ID</label>
                                  <input type="text" id="cidBasic" class="form-control" placeholder="Enter Class ID" name="class_id" required/>
                                </div>
                              </div>

                              <div class="row">
                                <div class="col mb-3">
                                  <label for="cnlBasic" class="form-label">Class Name</label>
                                  <input type="text" id="cnBasic" class="form-control" placeholder="Enter Class Name" name="class_name" required/>
                                </div>
                              </div>
                              ...
                              <div class="row">
                                <div class="col mb-3">
                                  ...
                                  <input type="text" id="cidBasic" class="form-control" placeholder="Enter College ID" name="college_id" value="<?php echo "$college_id";?>" required/>                                  
                                </div>
                              </div>
                            ...
                            <div class="modal-footer">
                              ...
                              <button type="submit" class="btn btn-primary" name="add-class">Add Classroom</button>
                            </div>
                          </div>
                        </div>
                      </div>
                    ...
                    <?php
                      if(isset($_POST['add-class']))
                      {
                        ...
                        $check = "SELECT * FROM class_admin where college_id = '$college_id'";
                        $check_user = mysqli_query($data,$check);

                         $sql = "INSERT INTO class_admin(fname, phone, id, password, class_name, class_id, college_id) VALUES('$fname', '$phone', '$id', '$password', '$class_name', '$class_id', '$college_id')";
                         $result = mysqli_query($data, $sql);

                         if($result)
                         {
                            $_SESSION['class-add'] = 'Classroom Added Succesfully! Please reload the page!';
                            header("location:admin-class-teachers.php");
                         }
                         else
                         {
                             $_SESSION['no_class-add'] = 'Failed to add classroom. Try again!';
                             header("location:admin-class-teachers.php");
                         }
                      }
                      ...
                      if(isset($_POST['delete-all']))
                      {
                        ...
                        $delete_sql = "DELETE FROM class_admin where college_id = '$college_id'";
                        $delete = mysqli_query($data,$delete_sql);

                        if($delete)
                         {
                            $_SESSION['delete_all'] = 'All classrooms were deleted!';
                            header("location:admin-class-teachers.php");
                         }
                         else
                         {
                             $_SESSION['no_delete_all'] = 'Failed to delete classrooms. Try again!';
                             header("location:admin-class-teachers.php");
                         }
                      }
                    ?>
              ...
              unset($_SESSION['class-add']);

              if($_SESSION['no_class-add'])
              {
                echo "<div class='alert alert-danger alert-dismissible' role='alert' id='alert_toast' style='font-size: 1rem; margin-top: 10px; font-weight: bolder;'>"
                .$_SESSION['no_class-add'].
                "<button type='button' class='btn-close' data-bs-dismiss='alert' aria-label='Close'></button>
              </div>";
              }
              unset($_SESSION['no_class-add']);
              ?>
            ...
            <div class="card">
              ...
              <?php
                ...
                unset($_SESSION['class-delete']);                
              ?>

                <h5 class="card-header">List of Classrooms(<?php echo "$class_count"; ?>)</h5>
                <div class="table-responsive text-nowrap">
                  <table class="table table-hover">
                    <thead class="class">
                      <tr>
                        <th class="class">Class Teacher</th>                    
                        <th class="class">Class Teacher ID</th>
                        <th class="class">Class Name</th>
                        <th class="class">Class ID</th>
                        <th class="class">Phone</th>
                        <th class="class">College Name</th>
                    ...
                    ?>
                      ...
                      <tr>
                        <td><?php echo "<a href='admin-ct-profile.php?id={$id}'>{$class[0]}</a>";?></td>                        
                        <td><?php echo "{$class[2]}";?></td>

                        <td>
                        <?php
                            echo "<a href='admin-class.php?id={$class[5]}' style='color: #5127e9; font-weight: 700;'>";
                          ?>
                            <?php echo "{$class[4]}"; ?>
                          </a>
                        </td>
                        ...
                        <td>  
                        <?php 
                          echo "<a onClick=\" javascript:return confirm('Are you sure to delete this class?')\" href='admin-ca-delete.php?id={$class[2]}'>
