...
$ca_id = $_SESSION['id'];
$sql = "SELECT * FROM class_admin WHERE id = '$ca_id' ";
...
$student_count_sql = "SELECT COUNT(*) FROM student_table WHERE class_id = '$class_id' ";
...
$course_count_sql = "SELECT COUNT(*) FROM courses WHERE class_id = '$class_id' ";
            ...
            <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
              ...
              <ul class="navbar-nav flex-row align-items-center ms-auto">
                ...
                <li class="nav-item navbar-dropdown dropdown-user dropdown">
                  <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
                    ...
                    <?php
                      $sql = "SELECT profile_picture FROM class_admin WHERE id = '$ca_id'";
              ...
              <div class="layout-main">
                <div class="left-column">
                  ...
                  <div class="head-card" id="ca-head-card">
                      <h1 class="welcome"> Welcome <?php echo "{$info['fname']}"; ?> </h1>
                      <p class="wel-text" id="ca-wel">Wishing a good day to you. Enjoy your day! Get started with s-tracker and start the adventure!</p>
                  </div>

                  <div class="main-cards" id="ca-main-cards">

                    <div class="cards1" id="ca-cards">
                        <a href="ca-class.php" id="card-link">
                            <div class="ca-letter">
                              ...
                              My Classroom</h1>
                              <span class="number">Class teacher: <?php echo "{$info['fname']}"; ?></span><br>
                              <span class="number">Number of students: <?php echo "$student_count"; ?></span><br>
                              <span class="number">Number of courses: <?php echo "$course_count"; ?></span>                              
                              <img src="Images\teacher.png" class="ca-teach">
                            </div>
                        </a>
                        <a href="ca-students.php" id="card-link">
                            <div class="ca-letter">
                              <h1 class="layout-head">&emsp;&emsp;
                              ...
                              Manage Students</h1>
                              <span class="number">Number of Students:</span><br>
                              <span class="n" data-target="35"><?php echo "$student_count"; ?></span>
                              <img src="Images\students.png" class="studs">
                            </div>
                        </a>
                        <a href="ca-courses.php" id="card-link">
                            <div class="ca-letter">
                              <h1 class="layout-head">&emsp;&emsp;                              
                              ...
                              <span class="n" data-target="35"><?php echo "$course_count"; ?></span>
                              <img src="Images\course.png" class="courses">
                            </div>                            
                        </a>                        
                        <a href="ca-pofile.php" id="card-link" style="color: inherit">
                            <div class="ca-letter" id="ca-profile">
                              <h1 class="layout-head">&emsp;&emsp;
                              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width=22 fill=#566A7F>
                                <path d="M399 384.2C376.9 345.8 335.4 320 288 320H224c-47.4 0-88.9 25.8-111 64.2c35.2 39.2 86.2 63.8 143 63.8s107.8-24.7 143-63.8zM0 256a256 256 0 1 1 512 0A256 256 0 1 1 0 256zm256 16a72 72 0 1 0 0-144 72 72 0 1 0 0 144z"/>
                              </svg>
                              Profile</h1>
                              <span class="ca-prof-card">Name: <?php echo "{$info['fname']}" ?></span><br>
                              <span class="ca-prof-card">Phone: <?php echo "{$info['phone']}" ?></span><br>
                              <span class="ca-prof-card">College: <?php echo "$college_name" ?></span><br>                              
                              <img src="Images/z_profile.jpg" class="ca-prof">
                            </div>
                        </a>
                    </div>
                  </div>
              ...
              <script>
                const counters = document.querySelectorAll(".n");
                const speed = 200;
