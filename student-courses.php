              ...
              <div class="studentview" style="margin: 100px 0px 80px 120px; width: 80%">
                ...
                Your Courses<h1>
                      ...
                      <?php
                        ...
                        $sc_sql = "SELECT * FROM student_course WHERE student_id = '$id'; ";
                      ...
                      <ul class="s-course-list">                      
                        <li>
                          <h3 class="s-head">
                            <?php
                              echo "<a href='student-prediction.php?id={$items[3]}' style='color: inherit;'>";
                              echo "{$items[4]}" 
                            ?>
                            </h3>
                          <p class="s-para">
                          ...
                          <?php
                            echo "<a href='student-teacher-profile.php?id={$teach[2]}' style='color: inherit;'>";
                            echo "{$teach[0]}";
                          ?>
                          </a>
