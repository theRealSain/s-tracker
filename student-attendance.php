      ...
      <div class="layout-container">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item">
              <a href="student-attendance.php" class="menu-link" id="active-side-menu">
              ...
              <div class="studentview" style="margin: 40px 0px 80px 120px; width: 95%">
                ...
                <select class="form-control" id="course-select" name="attendance_form" onchange="this.form.submit()">
                    ...
                    <?php
                      ...
                      $c2_sql = "SELECT * FROM student_course WHERE student_id = '$id' ";
                    ...
                    ?> 
                      ...
                      <?php
                          if (isset($_POST['attendance_form'])) 
                          {
                            ...
                            $a_sql = "SELECT * FROM attendance_table WHERE student_id = '$id' AND course_id = '$selected_course_id';";
                            $total = mysqli_query($data,"SELECT COUNT(attendance) from attendance_table where student_id = '$id' and course_id = '$selected_course_id'");
                            $present = mysqli_query($data,"SELECT COUNT(attendance) from attendance_table where student_id = '$id' and course_id = '$selected_course_id' and attendance='Present';");                                            
                ...
                <span class="at-perc" id="percent">Your Attendance: 
                  <?php  
