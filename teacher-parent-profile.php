      ...
      <div class="layout-container">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item">
              <a href="teacher-feedback.php" class="menu-link" id="active-side-menu">
            ...
            <div class="profile-page">
              ...
              <div class="profile-table">
                ...
                <table border=0>
                  ...
                  <tr>
                    <td class="profile-table-value1">Student Name:</td>
                    <td class="profile-table-value2"><?php echo "{$std_info['fname']}" ?></td>
                  </tr>
                </table>          
                
                <button class="add" id="ad-pf-up"><a href="teacher-feedback.php">back</a></button>
