...
>
  <head>
    ...
    <title>S-Tracker-Parent Login</title>
        ...
        <div class="authentication-inner">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <!-- /Logo -->
              <h4 class="mb-2"><b>Parent Login</b></h4>
              <p class="mb-4">Please sign-in to your account and start the adventure</p>

              <form id="formAuthentication" class="mb-3" action="parent-validation.php" method="POST">
                <div class="mb-3">
                  <label for="Parent_id" class="form-label">Parent ID</label>
                  <input type="text" class="form-control" id="email" name="id"
                    placeholder="Enter Parent ID" autofocus required>
                </div>
                ...
                <span class="reg">Already have an account? <a href="parent-reg.php">Sign Up</a></span><br>
