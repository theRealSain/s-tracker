...
>
  <head>
    ...
    <title>S-Tracker-Parent Registration</title>
        ...
        <div class="authentication-inner">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <!-- /Logo -->
              <h4 class="mb-2"><b>Parent Registration</b></h4>
              <p class="mb-4">Enter the world of S-Tracker by creating an account here!</p>

              <form id="formAuthentication" class="mb-3" action="parent-register.php" method="POST">
              ...
              <div class="mb-3">
                ...
                <div class="mb-3">
                  ...
                  <input type="text" class="form-control" id="email" name="id"
                    placeholder="Enter parent_id" autofocus required>
                </div>
                ...
                <div class="mb-3">
                  ...
                  <input type="text" class="form-control" id="email" name="student_id"
                    placeholder="Enter student_id" autofocus required>
                </div>
                ...
                <span class="reg">Already have an account? <a href="parent-login.php">Sign In</a></span><br>
