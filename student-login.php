...
>
  <head>
    ...
    <title>S-Tracker-Student Login</title>
        ...
        <div class="authentication-inner">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <!-- /Logo -->
              <h4 class="mb-2"><b>Student Login</b></h4>
              <p class="mb-4">Please sign-in to your account and start the adventure</p>

              <form id="formAuthentication" class="mb-3" action="student-validation.php" method="POST">
                <div class="mb-3">
                  <label for="student_id" class="form-label">Student ID</label>
                  <input type="text" class="form-control" id="email" name="id"
                    placeholder="Enter Student ID" autofocus required>
                </div>
                ...
                <div class="mb-3">
                  <button class="btn btn-primary d-grid w-100" type="submit">Sign in</button><br>
